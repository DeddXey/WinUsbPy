...
from .winusbclasses import UsbSetupPacket, LpOverlapped, UsbInterfaceDescriptor, LpSecurityAttributes, GUID, \
...
def get_winusb_functions(windll):
    ...
    winusb_argtypes[WinUsb_GetDescriptor] = [c_void_p, c_ubyte, c_ubyte, c_ushort, POINTER(c_ubyte), c_ulong,
                                             POINTER(c_ulong)]
